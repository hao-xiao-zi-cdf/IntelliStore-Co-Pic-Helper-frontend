<template>
  ...
  <a-flex gap="16" justify="center" class="button-group">
...
import { createPictureOutPaintingTaskUsingPost, getPictureOutPaintingTaskUsingGet, uploadPictureUsingPost } from '@/api/tupianxiangguanjiekou.ts'
